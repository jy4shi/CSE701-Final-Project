...
Create a text file named `input_function.txt`, write down the necessary parameters (see Restrictions on `input_function.txt` below), and then save the text file in the current workspace folder
